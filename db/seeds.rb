...
amelie = User.create(first_name: "Amelie", last_name: "Oller", email: "amelie.oller@flatironschool.com", status: "Available")
hal = User.create(first_name: "Hal", last_name: "Dunn", email: "hal.dunn@flatironschool.com", status: "Out Riding")
alec = User.create(first_name: "Alec", last_name: "DuBois", email: "after.alec@gmail.com", status: "Probably Coding")
zana = User.create(first_name: "Zana", last_name: "Hertica", email: "zhertica@gmail.com", status: "Practicing Backflips")
brad = User.create(first_name: "Brad", last_name: "Beggs", email: "brad.beggs@gmail.com", status: "Climbing")
akiko = User.create(first_name: "Akiko", last_name: "Green", email: "agreen17@mail.ccsf.edu", status: "Reachable")
daniel = User.create(first_name: "Daniel", last_name: "Patnode", email: "dbpatnode@hotmail.com", status: "Hang Gliding")
danira = User.create(first_name: "Danira", last_name: "Cortez", email: "cortezd334@yahoo.com", status: "Making Guac")
nathan = User.create(first_name: "Nathan", last_name: "Chung", email: "chung.nathanh@gmail.com", status: "Making Pottery")
ronak = User.create(first_name: "Ronak", last_name: "Soni", email: "ronakvsoni@gmail.com", status: "Working Out")
brandon = User.create(first_name: "Brandon", last_name: "Backer", email: "btbacker@gmail.com", status: "Busy")
don = User.create(first_name: "Don", last_name: "Mallory", email: "dmm333@gmail.com", status: "Away")
